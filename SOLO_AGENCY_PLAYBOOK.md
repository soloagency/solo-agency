...
required inline `assets/group_cover.png` image under the setup-chat visual contract in
`playbooks/SETUP_FLOW_ENTRYPOINT.md`. This is a real Markdown image in chat, never an explanatory
line, a link, or a relative-path example.
