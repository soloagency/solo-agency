...
Guardrail: the Codex built-in browser pane and any agent-driven browser stay FORBIDDEN for private data sources (Facebook, groups, feeds, profiles) exactly as `playbooks/00_CORE_CONTEXT_REQUIREMENTS.md` says; this rule is for the localhost dashboard only.
