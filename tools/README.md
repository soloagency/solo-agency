...
| `crm_store.py` | the ONLY sanctioned writer of `crm/` collections: contacts, deals, activities, tasks, pipelines, suppression + the deterministic rules engine. |
...
| `provider_openapi.py` | WideCast notification provider adapter (Telegram + report-link upload). |
