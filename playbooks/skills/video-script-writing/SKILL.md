...
**Outbound copy gate:** final narration contains no literal `—`, `&mdash;`, `&#8212;`, `&#x2014;`, or rhetorical `--`. Use a period or another natural separator, keep the shortest wording that preserves the evidence and necessary caveats, and cut filler, repetition, recap, and stacked clauses before delivery or provider handoff.
