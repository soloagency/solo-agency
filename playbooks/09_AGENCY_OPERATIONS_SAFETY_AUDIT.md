...
15. If private data sources exist but are not active yet, the automation contract includes `Private Data Sources Pending Activation` and lists the pending sources.
16. If no private data sources were provided, the agent offered optional private data source discovery or recorded that discovery was declined/postponed.
...
- [ ] In Automation Flow, did I avoid jumping to the first report before custom source status, step 7's one first-run question (Chạy lượt đầu), schedule/routine, and client-specific automation task were resolved or honestly marked pending?
...
- [ ] Did I avoid asking any source-approval question before step 7 (Chạy lượt đầu) after automation exists (the Local Collector itself was already installed at step 4, and custom source URLs were already asked once at step 5)?
