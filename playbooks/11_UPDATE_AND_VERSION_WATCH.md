...
- GitHub `main` for `https://github.com/OWNER/outreachcrm` is the source of truth.
...
2. Clone `https://github.com/OWNER/outreachcrm` into that folder.
...
- Raw GitHub files from `https://raw.githubusercontent.com/OWNER/outreachcrm/main/` only for instruction reload when a full clone is blocked.
