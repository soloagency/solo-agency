...
|---|---|---|
| name | `name` | display name (`"Alex Rivera"`) |
...
```json
{"name":{"full":"Tyler Delgado","given":"Tyler","entity_type":"person"},
 "identities":{"emails":[{"address":"agent@example.com","source":"zillow_harvest","status":"unverified","is_primary":true}],
               "phones":[{"number":"(555) 555-0143","type":"cell","source":"zillow_harvest"}],
               "socials":{"zillow":"https://www.zillow.com/profile/sampleagent","instagram":"https://www.instagram.com/sampleagent/"},
               "website":"https://example.com/team/sample-agent/"},
 "tags":["zillow_directory","zillow_harvest"],
 "custom_fields":{"source":"zillow_harvest","industry":"Real Estate","brokerage":"Sample Realty","location":"Venice, CA 90291"}}
```
