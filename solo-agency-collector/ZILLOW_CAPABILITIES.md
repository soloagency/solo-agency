...
```json
{"name":{"full":"Tyler Delgado"},
 "identities":{"emails":["agent@example.com"],"phones":["(555) 555-0143"],
 ...
 "custom_fields":{"source":"zillow.profile.enrich","industry":"Real Estate","brokerage":"Sample Realty","location":"Venice, CA 90291"}}
```
