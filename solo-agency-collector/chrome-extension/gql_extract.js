...
(function () {
  ...
  // the About sub-tabs (contact_info → intro → basic_info → links). Measured: sample.business
  // showed it on all five, sample.lead only on MAIN (once "See more" was expanded) and
