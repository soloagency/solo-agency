...
When the user asks to set up this repo, always read `OUTREACHCRM_PLAYBOOK.md` first and follow its checklist in order. The authoritative design is `docs/DESIGN.md`; when any file disagrees with it, `docs/DESIGN.md` wins.
